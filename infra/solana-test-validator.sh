...
solana-test-validator --account ${SWITCHBOARD_SOL_ORACLE} programs/sol_30_oracle_switchboard.json \
    --account ${SWITCHBOARD_BTC_ORACLE} programs/btc_20000_oracle_switchboard.json --reset \
    --bpf-program ${RFQ} programs/rfq.so \
