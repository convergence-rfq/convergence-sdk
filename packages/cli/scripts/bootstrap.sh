...
convergence risk-engine set-risk-categories-info $OPTS --new-value=0.05,0.5,0.02,0.2,0.04,0.3,0.08,0.4,0.12,0.5,0.2,0.6,0.3,0.7 --category=very-low   
convergence risk-engine set-risk-categories-info $OPTS --new-value=0.05,0.8,0.04,0.4,0.08,0.6,0.16,0.8,0.24,1.0,0.4,1.2,0.6,1.4 --category=low       
convergence risk-engine set-risk-categories-info $OPTS --new-value=0.05,1.2,0.06,0.6,0.12,0.9,0.24,1.2,0.36,1.5,0.6,1.8,0.9,2.1 --category=medium    
convergence risk-engine set-risk-categories-info $OPTS --new-value=0.05,2.4,0.08,0.8,0.16,1.2,0.32,1.6,0.48,2.0,0.8,2.4,1.2,2.8 --category=high      
convergence risk-engine set-risk-categories-info $OPTS --new-value=0.05,5.0,0.10,1.0,0.20,1.5,0.40,2.0,0.60,2.5,1.0,3.0,1.5,3.5 --category=very-high 
