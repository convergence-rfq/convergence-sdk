export type ConvergenceRfqErrorSource =
  | "sdk"
  | "network"
  | "rpc"
  | "plugin"
...
export type ConvergenceRfqErrorInput = {
  key: string;
  title: string;
  problem: string;
  solution: string;
  source: ConvergenceRfqErrorSource;
  sourceDetails?: string;
  options?: ConvergenceRfqErrorOptions;
};

export type ConvergenceRfqErrorInputWithoutSource = Omit<
  ConvergenceRfqErrorInput,
  "source" | "sourceDetails"
>;

export type ConvergenceRfqErrorOptions = {
  problem?: string;
...
/** @group Errors */
export class ConvergenceRfqError extends Error {
  readonly name: "ConvergenceRfqError" = "ConvergenceRfqError";
  readonly key: string;
  readonly title: string;
  readonly problem: string;
  readonly solution: string;
  readonly source: ConvergenceRfqErrorSource;
  readonly sourceDetails?: string;
  readonly cause?: Error;
  readonly logs?: string[];

  constructor(input: ConvergenceRfqErrorInput) {
    super(input.problem);
