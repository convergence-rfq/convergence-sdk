...
// export type ConvertInstrumentsDataToInstrmentsWithTnxResult = {
//   legInstruments: LegInstrument[];
//   optionMarketTxArray: TransactionBuilder[];
// };

// export const convertInstrumentsDataToInstrmentsWithTnx = async (
//   convergence: Convergence,
//   instrumentsData: LegInstrumentInputData[]
// ): Promise<ConvertInstrumentsDataToInstrmentsWithTnxResult> => {
...
//       case 'Spot':
//         const spotLegInstrument = await SpotLegInstrument.create(
//           convergence,
//           instrumentData.baseMint,
//           instrumentData.amount,
//           instrumentData.side
//         );
//         instruments.push(spotLegInstrument);

//       case 'Option':
//         if (instrumentData.metadata?.venue === 'Psyoptions') {
//           switch (instrumentData.metadata.optionStyle) {
//             case 'European':
//               const {
//                 optionMarketTxBuilder: europeanOpMarketTxBuilder,
//                 psyEuropeanInstrument,
//               } = await createPsyEuropeanInstrument(
//                 instrumentData,
//                 convergence,
//                 ixTracker
//               );
//               instruments.push(psyEuropeanInstrument);
//               if (europeanOpMarketTxBuilder)
//                 optionMarketTxArray.push(europeanOpMarketTxBuilder);
//               break;
//             case 'American':
//               const {
//                 optionMarketTxBuilder: americanOpMarketTxBuilder,
//                 psyAmericanInstrument,
//               } = await createPsyAmericanInstrument(
//                 instrumentData,
//                 convergence,
//                 ixTracker
//               );
//               instruments.push(psyAmericanInstrument);
//               if (americanOpMarketTxBuilder)
//                 optionMarketTxArray.push(americanOpMarketTxBuilder);
//               break;
//           }
//         }
//         break;
